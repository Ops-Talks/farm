...
vi.mock("@/lib/api-client", () => ({
  docs: {
    list: (...args: any[]) => mockListDocs(...args),
    tree: (...args: any[]) => mockTreeDocs(...args),
    get: (...args: any[]) => mockGetDoc(...args),
    getRendered: (...args: any[]) => mockGetRenderedDoc(...args),
    search: (...args: any[]) => mockSearchDocs(...args),
    create: vi.fn(),
    update: vi.fn(),
    delete: vi.fn(),
  },
  catalog: {
    listComponents: (...args: any[]) => mockListComponents(...args),
  },
