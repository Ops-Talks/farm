...
describe('EcrAdapter', () => {
  ...
  describe('listRepositories()', () => {
    it('should return repositories from ECR', async () => {
      mockSend.mockResolvedValueOnce({
        repositories: [
          { repositoryName: 'my-app', repositoryUri: '123.dkr.ecr.us-east-1.amazonaws.com/my-app' },
        ],
        nextToken: undefined,
      });
    ...
    it('should return empty array when no repositories exist', async () => {
      mockSend.mockResolvedValueOnce({ repositories: [], nextToken: undefined });
  ...
  describe('getManifest()', () => {
    ...
    it('should throw when image is not found', async () => {
      ...
      await expect(adapter.getManifest('my-app', 'nonexistent')).rejects.toThrow();
    });
  });
  ...
  describe('getScanResults()', () => {
    ...
    it('should re-throw unexpected errors', async () => {
      ...
      await expect(adapter.getScanResults('my-app', 'latest')).rejects.toThrow('Network error');
    });
  });
});
