...
### Fixed
- **release**: sync package-lock.json during release-it version bump (#272).
...
### Changed
- **docs**: Several improvements and Mermaid diagrams (#237).

## [0.26.0] - 2026-06-18

### Changed
- **web**: Several improvements at front-end (#236).
- **agents**: Update agents of project (#235).
...
### Added
- **prometheus**: Update Prometheus Rules using Sloth (#211).

## [0.25.23] - 2026-06-03

### Fixed
- **release**: align Helm chart version with app version (#210).
- **docker**: Fix wrong platform implementation (#209).
...
### Added
- **admin**: Add new feature to admin panel (#199).
